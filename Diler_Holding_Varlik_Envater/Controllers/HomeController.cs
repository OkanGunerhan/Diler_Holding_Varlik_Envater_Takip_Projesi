...
namespace Diler_Holding_Varlik_Envater.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ActionResult drpDwnLstIsletimSistemi()
        {
            //var list = new List<string>() { "XP", "Windows 7", "windows 8", "Windows 10" };
            //ViewBag.list = list;
            //return View();
