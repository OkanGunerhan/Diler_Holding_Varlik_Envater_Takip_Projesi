...
{
    public class Yazilim_TeamsController : Controller
    {
        ...
        // GET: Yazilim_Teams/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: Yazilim_Teams/Create
